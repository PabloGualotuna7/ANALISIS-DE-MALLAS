...
* Los errores relativos no pasan del 1% por lo cual nuestros valores son casi perfectos y no hay fallo en la medición en la medición que realizamos, esto debido tambien a que los simuladores usamos son un software programdo un cierto número de decimales mientras que nosotros usamos como máximo de dos decimales validos.
